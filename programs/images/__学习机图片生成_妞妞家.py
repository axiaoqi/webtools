...
def run(shop_type):
    ...
    primary_images_dir = [SynologyDrive / r'01新项目记录\闲鱼项目\AI学习机\02图片\01主图\网上找的',
                          SynologyDrive / fr'01新项目记录\闲鱼项目\AI学习机\02图片\01主图\自己拍的_{shop_type}']
    # 目标文件夹
    destination = SynologyDrive / fr'01新项目记录\闲鱼项目\AI学习机\00_学习机原图\{shop_type}'  # 目的地路径
...
def run_web_images():
    ...
    """
    # 主图文件夹
    primary_images_dir = [SynologyDrive / r'01新项目记录\闲鱼项目\AI学习机\02图片\01主图\自己拍的_妞妞家']
    # 目标文件夹
    destination = SynologyDrive / fr'01新项目记录\闲鱼项目\AI学习机\00_学习机原图\网上找的'  # 目的地路径
    ...
    for target_folder in target_folders:
        ...
        copy_random_images(3, other_images_dir, target_folder)
